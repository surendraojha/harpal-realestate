            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-8 col-lg-9">
                    <div class="property-gallery">
                        <h3>{{ $information->title }} <span>ID: {{ $information->ad_id }}</span></h3>
                        <h4>Price: {{ $information->price }}</h4>
                        ...
                        <ul class="list-info">
                            <li><span>Type:</span><a
                                    href="#">{{ @$information->subcategory->category->category->title }}</a></li>
                        ...
                        <ul class="list-detail">
                            @foreach ($additional_features as $value)
                                <li><i class="fa fa-check"></i> {{ $value->feature->title }}</li>
                            @endforeach
