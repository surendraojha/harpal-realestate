...
<head>
    ...
    <!--Font Awesome CSS-->
    <link rel="stylesheet" href="{{ asset('front-new/css/all.css') }}">

    <!--Main CSS-->
    <link rel="stylesheet" href="{{ asset('front-new/css/style.css') }}">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12 col-sm-12 col-md-4 col-lg-4 logo-left">
          <a href="{{ route('front.home') }}" class="logo"><img src="{{ asset('uploads/'.$setting->company_logo) }}" alt=""></a>
        </div>
        ...
        <div class="col-12 col-sm-12 col-md-4 col-lg-4 header-right">
          <ul>
            ...
            <li title="Post"><a href="{{ route('commercial-property.create') }}"><i class="fa-solid fa-pen-to-square"></i> <span class="bell-message">1</span></a></li>
            <li title="Message"><a href="#"><i class="fa fa-comment"></i> <span class="bell-message">1</span></a></li>
            <li title="Signin / Login"><a href="{{ route('front.login') }}" class="login"><i class="fa fa-user"></i></a></li>
          </ul>
        </div>
      </div>
    </div>
...
<script src="{{ asset('front-new') }}/js/bootstrap.min.js"></script>
<script src="{{ asset('front-new') }}/js/popper.min.js"></script>
