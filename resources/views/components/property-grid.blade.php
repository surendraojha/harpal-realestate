<div class="property-grid">
    <a href="{{ route('property.detail',$information->slug) }}">
        ...
        @if (isset($information->featured_photo) && file_exists(public_path('uploads/' . $information->featured_photo)))
            <img src="{{ asset('uploads/' . $information->featured_photo) }}" alt="{{ $information->title }}">
        @else
    ...
    <div class="pro-box">
        ...
        <ul class="listing">
            ...
            <li>Area: {{ $information->area_covered }} * {{ $information->buld_up_area }}</li>
        </ul>
