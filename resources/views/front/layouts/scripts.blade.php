...
<script src="{{ asset('front/assets/plugins/bootstrap/js/popover.min.js') }}"></script>
<script src="{{ asset('front/assets/plugins/bootstrap/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('front/assets/plugins/niceselect/jquery.nice-select.js') }}"></script>
<script src="{{ asset('front/assets/plugins/slider/swiper.min.js') }}"></script>
<script src="{{ asset('front/assets/js/jquery-ui.min.js') }}"></script>
<script src="{{ asset('front/assets/js/select.min.js') }}"></script>
<script src="{{ asset('front/assets/js/datepicker/theme/js/t-datepicker.min.js') }}"></script>
