    ...
    <div id="main-content">
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('meta-tag.index') }}" method="get">
                            <div class="body">
                                <div class="row">
                        ...
                        <div class="tab-content mt-0">
                                                ...
                                                @foreach ($informations as $value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{ route('meta-tag.edit', $value->id) }}"> <i
                            ...
                            <div class="tab-pane @if (session()->get('errors')) active show @endif" id="addUser">
                                <div class="body mt-2">
                                    ...
                                    {!! Form::open(['route' => 'meta-tag.store', 'method' => 'post', 'files' => true]) !!}

                                    @csrf
                                    @include('admin.meta-tag.form')
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">Add</button>
                                        <a class="btn btn-secondary" href="{{ route('meta-tag.index') }}">
                                            Close
                                        </a>
                                    </div>
                                    {!! Form::close() !!}
