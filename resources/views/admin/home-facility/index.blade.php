                    ...
                    <div class="tab-content mt-0">
                            ...
                            <div class="table-responsive">
                                <form method="post">
                                    ...
                                    <button class="btn btn-danger" onclick="return confirm('Are You Sure?')"
                                        formaction="{{ route('home-type.delete') }}" type="submit">
                                    ...
                                    <table class="table table-hover table-custom spacing8" id="myTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('home-facility.edit',$value->id)}}"> <i
                        ...
                        <div class="tab-pane @if(session()->get('errors'))  active show  @endif" id="addUser">
                            <div class="body mt-2">
                                ...
                                {!! Form::open(['route' => 'home-facility.store', 'method' => 'post']) !!}

                                    @csrf
                                    @include('admin.home-facility.form')
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">Add</button>
                                        <a class="btn btn-secondary" href="{{route('home-facility.index')}}">
                                            Close
                                        </a>
                                    </div>
                                {!! Form::close() !!}
