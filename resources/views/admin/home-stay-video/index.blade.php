...
<div id="main-content">
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-12">
                <div class="card">
                    <form action="{{route('home-stay-video.index')}}" method="get">
                        <div class="body">
                            <div class="row">
                    ...
                    <div class="tab-content mt-0">
                            ...
                            <div class="table-responsive">
                                <form method="post">
                                    ...
                                    <button class="btn btn-danger" onclick="return confirm('Are You Sure?')"
                                        formaction="{{ route('home-stay-video.delete') }}" type="submit">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                   ...
                                                   <iframe src="{{$youtube_link}}" frameborder="0"></iframe>
                                                ...
                                                <td>
                                                    <a href="{{route('home-stay-video.edit',$value->id)}}"> <i
                        ...
                        <div class="tab-pane @if(session()->get('errors'))  active show  @endif" id="addUser">
                            <div class="body mt-2">
                                ...
                                {!! Form::open(['route' => 'home-stay-video.store', 'method' => 'post']) !!}

                                    @csrf
                                    @include('admin.home-stay-video.form')
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">Add</button>
                                        <a class="btn btn-secondary" href="{{route('home-stay-video.index')}}">
                                            Close
                                        </a>
                                    </div>
                                {!! Form::close() !!}
