...
<nav id="left-sidebar-nav" class="sidebar-nav">
    <ul id="main-menu" class="metismenu">
        ...
        @php
            $route = ['admin-residental-property.index', 'admin-residental-property.edit', 'admin-commerical-property.index', 'admin-commerical-property.edit', 'featured-property.index', 'featured-property.edit', 'recommended-property.index', 'recommended-property.edit', 'home-page-property.index', 'home-page-property.edit'];
        @endphp
