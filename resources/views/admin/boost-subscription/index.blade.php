                        ...
                        <div class="tab-content mt-0">
                            <div class="tab-pane  @if (!session()->get('errors')) active show @endif" id="Users">
                                <div class="table-responsive">
                                    <form method="post">
                                        ...
                                        @php
                                            $route = route('boost-subscription.delete');
                                        @endphp
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($informations as $value)
                                                    <tr style="color:{{ $value->color }}">
                                                        ...
                                                        <td>
                                                            <a href="{{ route('boost-subscription.edit', $value->id) }}"> <i
                            ...
                            <div class="tab-pane @if (session()->get('errors')) active show @endif" id="addUser">
                                <div class="body mt-2">
                                    ...
                                    {!! Form::open(['route' => 'boost-subscription.store', 'method' => 'post']) !!}

                                    @csrf
                                    @include('admin.boost-subscription.form')
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">Add</button>
                                        <a class="btn btn-secondary" href="{{ route('boost-subscription.index') }}">
                                            Close
                                        </a>
                                    </div>
                                    {!! Form::close() !!}
