                    ...
                    <div class="tab-content mt-0">
                                    ...
                                    <table class="table table-hover table-custom spacing8" id="myTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('home-type.edit',$value->id)}}"> <i
                        ...
                        <div class="tab-pane @if(session()->get('errors'))  active show  @endif" id="addUser">
                            <div class="body mt-2">
                                ...
                                {!! Form::open(['route' => 'home-type.store', 'method' => 'post']) !!}

                                    @csrf
                                    @include('admin.home-type.form')
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">Add</button>
                                        <a class="btn btn-secondary" href="{{route('home-type.index')}}">
                                            Close
                                        </a>
                                    </div>
                                {!! Form::close() !!}
