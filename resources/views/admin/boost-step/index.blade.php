                        ...
                        <div class="tab-content mt-0">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($informations as $value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('boost-step.edit', $value->id) }}"> <i
                            ...
                            <div class="tab-pane @if (session()->get('errors')) active show @endif" id="addUser">
                                <div class="body mt-2">
                                    ...
                                    {!! Form::open(['route' => 'boost-step.store', 'method' => 'post']) !!}

                                    @csrf
                                    @include('admin.boost-step.form')
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">Add</button>
                                        <a class="btn btn-secondary" href="{{ route('boost-step.index') }}">
                                            Close
                                        </a>
                                    </div>
                                    {!! Form::close() !!}
