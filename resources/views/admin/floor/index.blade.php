                        ...
                        <div class="tab-content mt-0">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($informations as $value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('floor.edit', $value->id) }}"> <i
                            ...
                            <div class="tab-pane @if (session()->get('errors')) active show @endif" id="addUser">
                                <div class="body mt-2">
                                    ...
                                    {!! Form::open(['route' => 'floor.store', 'method' => 'post']) !!}

                                    @csrf
                                    @include('admin.floor.form')
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">Add</button>
                                        <a class="btn btn-secondary" href="{{ route('floor.index') }}">
                                            Close
                                        </a>
                                    </div>
                                    {!! Form::close() !!}
