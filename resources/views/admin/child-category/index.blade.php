...
<div id="main-content">
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-12">
                <div class="card">
                    <form action="{{route('child-category.index')}}" method="get">
                        <div class="body">
                            <div class="row">
                    ...
                    <div class="tab-content mt-0">
                        <div class="tab-pane  @if(!session()->get('errors')) active show @endif" id="Users">
                            <div class="table-responsive">
                                ...
                                <x-check-box-td :value="$value" :user="$user"/>
                                                ...
                                                <td>
                                                    <a href="{{route('child-category.edit',$value->id)}}"> <i
                        ...
                        <div class="tab-pane @if(session()->get('errors'))  active show  @endif" id="addUser">
                            <div class="body mt-2">
                                ...
                                {!! Form::open(['route' => 'child-category.store', 'method' => 'post']) !!}

                                    @csrf
                                    @include('admin.child-category.form')
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">Add</button>
                                        <a class="btn btn-secondary" href="{{route('child-category.index')}}">
                                            Close
                                        </a>
                                    </div>
                                {!! Form::close() !!}
