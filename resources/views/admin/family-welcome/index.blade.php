                    ...
                    <div class="tab-content mt-0">
                            ...
                            <div class="table-responsive">
                                <form method="post">
                                    ...
                                    <button class="btn btn-danger" onclick="return confirm('Are You Sure?')"
                                        formaction="{{ route('family-welcome.delete') }}" type="submit">
                                    ...
                                    <table class="table table-hover table-custom spacing8" id="myTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('family-welcome.edit',$value->id)}}"> <i
                        ...
                        <div class="tab-pane @if(session()->get('errors'))  active show  @endif" id="addUser">
                            <div class="body mt-2">
                                ...
                                {!! Form::open(['route' => 'family-welcome.store', 'method' => 'post']) !!}

                                    @csrf
                                    @include('admin.family-welcome.form')
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">Add</button>
                                        <a class="btn btn-secondary" href="{{route('family-welcome.index')}}">
                                            Close
                                        </a>
                                    </div>
                                {!! Form::close() !!}
