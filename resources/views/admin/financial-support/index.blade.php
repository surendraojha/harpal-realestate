...
<div id="main-content">
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            {{-- <div class="col-12">
                <div class="card">
                    <form action="{{route('financial-support.index')}}" method="get">
                        <div class="body">
                            <div class="row">
                    ...
                    <div class="tab-content mt-0">
                            ...
                            <div class="table-responsive">
                                <form method="post">
                                    ...
                                    <button class="btn btn-danger" onclick="return confirm('Are You Sure?')"
                                        formaction="{{ route('financial-support.delete') }}" type="submit">
                                    ...
                                    <table class="table table-hover table-custom spacing8" id="myTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('financial-support.edit',$value->id)}}"> <i
                        ...
                        <div class="tab-pane @if(session()->get('errors'))  active show  @endif" id="addUser">
                            <div class="body mt-2">
                                ...
                                {!! Form::open(['route' => 'financial-support.store', 'method' => 'post','files'=>true]) !!}

                                    @csrf
                                    @include('admin.financial-support.form')
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">Add</button>
                                        <a class="btn btn-secondary" href="{{route('financial-support.index')}}">
                                            Close
                                        </a>
                                    </div>
                                {!! Form::close() !!}
