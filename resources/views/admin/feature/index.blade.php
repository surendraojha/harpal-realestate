                        ...
                        <div class="tab-content mt-0">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($informations as $value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('feature.edit', $value->id) }}"> <i
                            ...
                            <div class="tab-pane @if (session()->get('errors')) active show @endif" id="addUser">
                                <div class="body mt-2">
                                    ...
                                    {!! Form::open(['route' => 'feature.store', 'method' => 'post']) !!}

                                    @csrf
                                    @include('admin.feature.form')
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">Add</button>
                                        <a class="btn btn-secondary" href="{{ route('feature.index') }}">
                                            Close
                                        </a>
                                    </div>
                                    {!! Form::close() !!}
