...
<div id="main-content">
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            {{-- <div class="col-12">
                <div class="card">
                    <form action="{{route('road-size.index')}}" method="get">
                        <div class="body">
                            <div class="row">
                    ...
                    <div class="tab-content mt-0">
                                ...
                                <form method="post">
                                    ...
                                    <table class="table table-hover table-custom spacing8" id="myTable">
                                        ...
                                        <x-check-box-td :value="$value" :user="$user"/>
                                                ...
                                                <td>
                                                    <a href="{{route('road-size.edit',$value->id)}}"> <i
                        ...
                        <div class="tab-pane @if(session()->get('errors'))  active show  @endif" id="addUser">
                            <div class="body mt-2">
                                ...
                                {!! Form::open(['route' => 'road-size.store', 'method' => 'post']) !!}

                                    @csrf
                                    @include('admin.road-size.form')
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">Add</button>
                                        <a class="btn btn-secondary" href="{{route('road-size.index')}}">
                                            Close
                                        </a>
                                    </div>
                                {!! Form::close() !!}
