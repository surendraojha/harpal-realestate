...
!(function (t, e) {
        ...
        p = (function (s) {
            ...
            function t(t) {
                var e = this,
                    i = !1;
                return (
                    s(this).one(a.TRANSITION_END, function () {
                        i = !0;
                    }),
                    setTimeout(function () {
            ...
            return (
                ...
                a.supportsTransitionEnd() &&
                    (s.event.special[a.TRANSITION_END] = {
                        bindType: e.end,
                        delegateType: e.end,
                        handle: function (t) {
    ...
    (r = jQuery),
            ...
            return (
                (a.prototype.init = function () {
                    ...
                    r(this._element)
                        ...
                        r(this._element)
                            ...
                            .on(h.CLICK_DATA_API, function (t) {
                                var e = r(this),
                                ...
                                n._config.preventDefault && t.preventDefault(),
                                    "true" !== e.attr("aria-disabled") &&
                                        (i.hasClass(n._config.activeClass) ? (e.attr("aria-expanded", !1), n._hide(a)) : (n._show(a), e.attr("aria-expanded", !0), n._config.toggle && s.attr("aria-expanded", !1)),
                ...
                (a.prototype._show = function (t) {
                    if (!this._transitioning && !r(t).hasClass(this._config.collapsingClass)) {
                        ...
                        if ((i.trigger(s), !s.isDefaultPrevented())) {
                            i.parent(this._config.parentTrigger).addClass(this._config.activeClass),
                                this._config.toggle &&
                                    this._hide(
                                        i
                            ...
                            var a = function () {
                                i
                                    ...
                                    .addClass(e._config.collapseClass + " " + e._config.collapseInClass)
                                    .height("")
                                    .attr("aria-expanded", !0),
                ...
                (a.prototype._hide = function (t) {
                    if (!this._transitioning && r(t).hasClass(this._config.collapseInClass)) {
                        var e = this,
                            ...
                            s = r.Event(h.HIDE);
                        if ((i.trigger(s), !s.isDefaultPrevented())) {
                            i.parent(this._config.parentTrigger).removeClass(this._config.activeClass),
                ...
                (a.prototype.dispose = function () {
                    r.removeData(this._element, o),
                        r(this._element).find(this._config.parentTrigger).has(this._config.subMenu).children(this._config.triggerElement).off("click"),
                        (this._transitioning = null),
                        (this._config = null),
                        (this._element = null);
                }),
        ...
        (r.fn[i] = c._jQueryInterface),
        (r.fn[i].Constructor = c),
                ...
                return (
                    this.each(function () {
                            ...
                            if (r) {
                                ...
                                (t = t || window.event).wheelDelta && (e = -t.wheelDelta / 120),
                                    ...
                                    w(t.target || t.srcTarget || t.srcElement)
                                        .closest("." + _.wrapperClass)
                                        .is(f.parent()) && s(e, !0),
                                    t.preventDefault && !g && t.preventDefault(),
                                    g || (t.returnValue = !1);
                            }
                        }
                        function s(t, e, i) {
                            ...
                            e && ((e = parseInt(m.css("top")) + ((t * parseInt(_.wheelStep)) / 100) * m.outerHeight()), (e = Math.min(Math.max(e, 0), s)), (e = 0 < t ? Math.ceil(e) : Math.floor(e)), m.css({ top: e + "px" })),
                                (e = (u = parseInt(m.css("top")) / (f.outerHeight() - m.outerHeight())) * (f[0].scrollHeight - f.outerHeight())),
                                i && ((t = ((e = t) / f[0].scrollHeight) * f.outerHeight()), (t = Math.min(Math.max(t, 0), s)), m.css({ top: t + "px" })),
                                f.scrollTop(e),
                        ...
                        function a() {
                            i(),
                                clearTimeout(h),
                                u == ~~u ? ((g = _.allowPageScroll), d != u && f.trigger("slimscroll", 0 == ~~u ? "top" : "bottom")) : (g = !1),
                                (d = u),
                                p >= f.outerHeight() ? (g = !0) : (m.stop(!0, !0).fadeIn("fast"), _.railVisible && y.stop(!0, !0).fadeIn("fast"));
                        }
                        function n() {
                            _.alwaysVisible ||
                        ...
                        if (f.parent().hasClass(_.wrapperClass)) {
                            ...
                            (_.height = "auto" == _.height ? f.parent().height() : _.height),
                                (v = w("<div></div>").addClass(_.wrapperClass).css({ position: "relative", overflow: "hidden", width: _.width, height: _.height })),
                                f.css({ overflow: "hidden", width: _.width, height: _.height });
                            (y = w("<div></div>")
                                .addClass(_.railClass)
                                .css({
                                    width: _.size,
                                    height: "100%",
                                    position: "absolute",
                            ...
                            y.css(b),
                                ...
                                i(),
                                "bottom" === _.start ? (m.css({ top: f.outerHeight() - m.outerHeight() }), s(0, !0)) : "top" !== _.start && (s(w(_.start).position().top, null, !0), _.alwaysVisible || m.hide()),
    ...
    (function (a) {
        ...
        (n.defaults = {
            ...
            (n.prototype.transition = function () {
                ...
                if (isNaN(p)) t("data-transitiongoal not set");
                    ...
                    var e,
                        m = Math.round((100 * (p - u)) / (d - u));
                    if ("center" === c.display_text && !l && !h)
                        (this.$back_text = l = a("<span>").addClass("progressbar-back-text").prependTo(o)),
                            (this.$front_text = h = a("<span>").addClass("progressbar-front-text").prependTo(r)),
                            g
                                ? ((e = o.css("height")),
                    ...
                    setTimeout(function () {
                        ...
                        var n = setInterval(function () {
                            g ? ((i = r.height()), (s = o.height())) : ((i = r.width()), (s = o.width())),
                                (t = Math.round((100 * i) / s)),
                                (e = Math.round(u + (i / s) * (d - u))),
                                m <= t && ((t = m), (e = p), v(r), clearInterval(n)),
                                "none" !== c.display_text && ((a = c.use_percentage ? c.percent_format(t) : c.amount_format(e, d, u)), "fill" === c.display_text ? r.text(a) : "center" === c.display_text && (l.text(a), h.text(a))),
        ...
        (a.fn.progressbar = function (s) {
            ...
            (a.fn.progressbar.Constructor = n),
        ...
        (t = function (z) {
            ...
            (t = function () {
                return {
                    ...
                    discrete: { lineHeight: "auto", thresholdColor: N, thresholdValue: 0, chartRangeMax: N, chartRangeMin: N, chartRangeClip: !1, tooltipFormat: new m("{{prefix}}{{value}}{{suffix}}") },
                    bullet: {
                        targetColor: "#f33",
                        targetWidth: 3,
                ...
                (e = function () {
                    ...
                    return (
                        ...
                        1 < arguments.length
                            ? (arguments[0] ? ((t.prototype = z.extend(new arguments[0](), arguments[arguments.length - 1])), (t._super = arguments[0].prototype)) : (t.prototype = arguments[arguments.length - 1]),
                              2 < arguments.length && ((e = Array.prototype.slice.call(arguments, 1, -1)).unshift(t.prototype), z.extend.apply(z, e)))
                    ...
                    render: function (t, e, i) {
                        ...
                        return this.format.replace(this.fre, function () {
                            return (
                                (a = arguments[1]),
                                (n = arguments[3]),
                                (s = l.precre.exec(a)) ? ((o = s[2]), (a = s[1])) : (o = !1),
                                (r = h[a]) === N
                                    ? ""
                                    : n && e && e[n]
                                    ? e[n].get
                                        ? e[n].get(r) || r
                                        : e[n][r] || r
                                    : (c(r) && (r = i.get("numberFormatter") ? i.get("numberFormatter")(r) : p(r, o, i.get("numberDigitGroupCount"), i.get("numberDigitGroupSep"), i.get("numberDecimalMark"))), r)
                            );
                        });
                    },
                })),
                ...
                (x = function (t, e) {
                    var i;
                    return 2 === e
                        ? ((i = B.floor(t.length / 2)), t.length % 2 ? t[i] : (t[i - 1] + t[i]) / 2)
                        : t.length % 2
                        ? (i = (t.length * e + e) / 4) % 1
                            ? (t[B.floor(i)] + t[B.floor(i) - 1]) / 2
                            : t[i - 1]
                        : (i = (t.length * e + 2) / 4) % 1
                        ? (t[B.floor(i)] + t[B.floor(i) - 1]) / 2
                        : t[i - 1];
                ...
                (i = function (t) {
                    ...
                    ((e = k.createElement("style")).type = "text/css"),
                        ...
                        i ? (k.styleSheets[k.styleSheets.length - 1].cssText = t) : (e["string" == typeof k.body.style.WebkitAppearance ? "innerText" : "innerHTML"] = t);
                }),
                (z.fn.simpledraw = function (t, e, i, s) {
                    ...
                    if (z.fn.sparkline.canvas === N) {
                        ...
                        if (r.getContext && r.getContext("2d"))
                            z.fn.sparkline.canvas = function (t, e, i, s) {
                                return new f(t, e, i, s);
                            };
                        else {
                            if (!k.namespaces || k.namespaces.v) return (z.fn.sparkline.canvas = !1);
                            k.namespaces.add("v", "urn:schemas-microsoft-com:vml", "#default#VML"),
                                (z.fn.sparkline.canvas = function (t, e, i, s) {
                                    return new v(t, e, i);
                                });
                        }
                    ...
                    init: function (t) {
                        ...
                        for (e in t)
                            t.hasOwnProperty(e) &&
                                "string" == typeof e &&
                                -1 < e.indexOf(":") &&
                                (((i = e.split(":"))[0] = 0 === i[0].length ? -1 / 0 : parseFloat(i[0])), (i[1] = 0 === i[1].length ? 1 / 0 : parseFloat(i[1])), (i[2] = t[e]), s.push(i));
                ...
                (u = e({
                    ...
                    mouseenter: function (t) {
                        z(k.body).unbind("mousemove.jqs"),
                            z(k.body).bind("mousemove.jqs", z.proxy(this.mousemove, this)),
                            (this.over = !0),
                            (this.currentPageX = t.pageX),
                            (this.currentPageY = t.pageY),
                            (this.currentEl = t.target),
                            !this.tooltip && this.displayTooltips && ((this.tooltip = new s(this.options)), this.tooltip.updatePosition(t.pageX, t.pageY)),
                            this.updateDisplay();
                    },
                    mouseleave: function () {
                        z(k.body).unbind("mousemove.jqs");
                ...
                (s = e({
                    ...
                    init: function (t) {
                        var e,
                            ...
                            s = this.sizeStyle;
                        (this.container = t.get("tooltipContainer") || k.body),
                            (this.tooltipOffsetX = t.get("tooltipOffsetX", 10)),
                            (this.tooltipOffsetY = t.get("tooltipOffsetY", 12)),
                            z("#jqssizetip").remove(),
                            z("#jqstooltip").remove(),
                            (this.sizetip = z("<div/>", { id: "jqssizetip", style: s, class: i })),
                            (this.tooltip = z("<div/>", { id: "jqstooltip", class: i }).appendTo(this.container)),
                            (e = this.tooltip.offset()),
                            (this.offsetLeft = e.left),
                            (this.offsetTop = e.top),
                            (this.hidden = !0),
                            z(window).unbind("resize.jqs scroll.jqs"),
                            z(window).bind("resize.jqs scroll.jqs", z.proxy(this.updateWindowDims, this)),
                    ...
                    setContent: function (t) {
                        ...
                        this.getSize(t), this.tooltip.html(t).css({ width: this.width, height: this.height, visibility: "visible" }), this.hidden && ((this.hidden = !1), this.updatePosition());
                    },
                ...
                (y = []),
                (z.fn.sparkline = function (h, i) {
                    return this.each(function () {
                        var t,
                            e,
                            o = new z.fn.sparkline.options(this, i),
                            l = z(this);
                        if (
                            ((t = function () {
                                var t, e, i, s, a, n, r;
                                "html" === h || h === N ? (((r = this.getAttribute(o.get("tagValuesAttribute"))) !== N && null !== r) || (r = l.html()), (t = r.replace(/(^\s*<!--)|(-->\s*$)|\s+/g, "").split(","))) : (t = h),
                                    (e = "auto" === o.get("width") ? t.length * o.get("defaultPixelsPerValue") : o.get("width")),
                                    "auto" === o.get("height")
                                        ? (o.get("composite") && z.data(this, "_jqs_vcanvas")) || (((s = k.createElement("span")).innerHTML = "a"), l.html(s), (i = z(s).innerHeight() || z(s).height()), z(s).remove(), (s = null))
                                        : (i = o.get("height")),
                                    o.get("disableInteraction") ? (a = !1) : (a = z.data(this, "_jqs_mhandler")) ? o.get("composite") || a.reset() : ((a = new u(this, o)), z.data(this, "_jqs_mhandler", a)),
                                    !o.get("composite") || z.data(this, "_jqs_vcanvas")
                                        ? ((n = new z.fn.sparkline[o.get("type")](this, t, o, e, i)).render(), a && a.registerSparkline(n))
                                        : z.data(this, "_jqs_errnotify") || (alert("Attempted to attach a composite sparkline to an element with no existing sparkline"), z.data(this, "_jqs_errnotify", !0));
                            }),
                ...
                (z.fn.sparkline.defaults = t()),
                (z.sparkline_display_visible = function () {
                    var t,
                        e,
                        i,
                        s = [];
                    for (e = 0, i = y.length; e < i; e++)
                        (t = y[e][0]),
                            z(t).is(":visible") && !z(t).parents().is(":hidden")
                                ? (y[e][1].call(t), z.data(y[e][0], "_jqs_pending", !1), s.push(e))
                                : z(t).closest("html").length || z.data(t, "_jqs_pending") || (z.data(y[e][0], "_jqs_pending", !1), s.push(e));
                ...
                (z.fn.sparkline.options = e({
                    init: function (t, e) {
                        ...
                        (this.userOptions = e = e || {}),
                            (this.tag = t),
                            (this.tagValCache = {}),
                            (a = (s = z.fn.sparkline.defaults).common),
                            (this.tagOptionsPrefix = e.enableTagOptions && (e.tagOptionsPrefix || a.tagOptionsPrefix)),
                            (i = (n = this.getTagSetting("type")) === b ? s[e.type || a.type] : s[n]),
                            (this.mergedOptions = z.extend({}, a, i, e));
                    },
                    getTagSetting: function (t) {
                        var e,
                            ...
                            s,
                            a,
                            n = this.tagOptionsPrefix;
                        if (!1 === n || n === N) return b;
                        if (this.tagValCache.hasOwnProperty(t)) e = this.tagValCache.key;
                        else {
                            if ((e = this.tag.getAttribute(n + t)) === N || null === e) e = b;
                            else if ("[" === e.substr(0, 1)) for (i = (e = e.substr(1, e.length - 2).split(",")).length; i--; ) e[i] = F(e[i].replace(/(^\s*)|(\s*$)/g, ""));
                            else if ("{" === e.substr(0, 1)) for (s = e.substr(1, e.length - 2).split(","), e = {}, i = s.length; i--; ) e[(a = s[i].split(":", 2))[0].replace(/(^\s*)|(\s*$)/g, "")] = F(a[1].replace(/(^\s*)|(\s*$)/g, ""));
                            else e = F(e);
                ...
                (z.fn.sparkline._base = e({
                    ...
                    setRegionHighlight: function (t, e, i) {
                        ...
                        return e > this.canvasWidth || i > this.canvasHeight || e < 0 || i < 0
                            ? null
                            : a !== (s = this.getRegion(t, e, i)) && (a !== N && n && this.removeHighlight(), (this.currentRegion = s) !== N && n && this.renderHighlight(), !0);
                    },
                    ...
                    getCurrentRegionTooltip: function () {
                        ...
                        for (i = e.length, u = t.length, n = 0; n < i; n++)
                            for ("string" == typeof (p = e[n]) && (p = new m(p)), s = p.fclass || "jqsfield", d = 0; d < u; d++)
                                (t[d].isNull && g.get("tooltipSkipNull")) ||
                                    (z.extend(t[d], { prefix: g.get("tooltipPrefix"), suffix: g.get("tooltipSuffix") }), (a = p.render(t[d], g.get("tooltipValueLookups"), g)), v.push('<div class="' + s + '">' + a + "</div>"));
                ...
                (a = {
                    changeHighlight: function (t) {
                        ...
                        a &&
                            ...
                            z.isArray(e) || z.isArray(a)
                                ? (s.replaceWithShapes(a, e),
                                  (this.regionShapes[i] = z.map(e, function (t) {
                                      return t.id;
                                  })))
                ...
                (z.fn.sparkline.line = A = e(z.fn.sparkline._base, {
                    type: "line",
                    init: function (t, e, i, s, a) {
                        A._super.init.call(this, t, e, i, s, a),
                            (this.vertices = []),
                            (this.regionMap = []),
                            (this.xvalues = []),
                            (this.yvalues = []),
                    ...
                    getCurrentRegionFields: function () {
                        ...
                        return { isNull: null === this.yvalues[t], x: this.xvalues[t], y: this.yvalues[t], color: this.options.get("lineColor"), fillColor: this.options.get("fillColor"), offset: t };
                    },
                    renderHighlight: function () {
                        var t,
                            e,
                        ...
                        a &&
                            (r && o && ((t = s.drawCircle(a[0], a[1], r, N, o)), (this.highlightSpotId = t.id), s.insertAfterShape(this.lastShapeId, t)),
                            l && ((e = s.drawLine(a[0], this.canvasTop, a[0], this.canvasTop + this.canvasHeight, l)), (this.highlightLineId = e.id), s.insertAfterShape(this.lastShapeId, e)));
                    },
                    removeHighlight: function () {
                        var t = this.target;
                    ...
                    scanValues: function () {
                        ...
                        for (t = 0; t < r; t++)
                            (e = n[t]),
                                (i = "string" == typeof n[t]),
                                (s = "object" == typeof n[t] && n[t] instanceof Array),
                                (a = i && n[t].split(":")),
                                i && 2 === a.length
                                    ? (o.push(Number(a[0])), l.push(Number(a[1])), h.push(Number(a[1])))
                                    : s
                                    ? (o.push(e[0]), l.push(e[1]), h.push(e[1]))
                                    : (o.push(t), null === n[t] || "null" === n[t] ? l.push(null) : (l.push(Number(e)), h.push(Number(e))));
                        this.options.get("xvalues") && (o = this.options.get("xvalues")),
                            (this.maxy = this.maxyorg = B.max.apply(B, h)),
                            (this.miny = this.minyorg = B.min.apply(B, h)),
                            (this.maxx = B.max.apply(B, o)),
                            (this.minx = B.min.apply(B, o)),
                            (this.xvalues = o),
                            (this.yvalues = l),
                            (this.yminmax = h);
                    },
                    processRangeOptions: function () {
                        ...
                        e !== N && (e < this.miny && (this.miny = e), i > this.maxy && (this.maxy = i)),
                            t.get("chartRangeMin") !== N && (t.get("chartRangeClip") || t.get("chartRangeMin") < this.miny) && (this.miny = t.get("chartRangeMin")),
                            t.get("chartRangeMax") !== N && (t.get("chartRangeClip") || t.get("chartRangeMax") > this.maxy) && (this.maxy = t.get("chartRangeMax")),
                            t.get("chartRangeMinX") !== N && (t.get("chartRangeClipX") || t.get("chartRangeMinX") < this.minx) && (this.minx = t.get("chartRangeMinX")),
                            t.get("chartRangeMaxX") !== N && (t.get("chartRangeClipX") || t.get("chartRangeMaxX") > this.maxx) && (this.maxx = t.get("chartRangeMaxX"));
                    },
                        ...
                        if (A._super.render.call(this) && (this.scanValues(), this.processRangeOptions(), (_ = this.xvalues), (w = this.yvalues), this.yminmax.length && !(this.yvalues.length < 2))) {
                            for (
                                s = a = 0,
                                    ...
                                    I && (R < 4 * I || M < 4 * I) && (I = 0),
                                    I &&
                                        (((b = k.get("highlightSpotColor") && !k.get("disableInteraction")) || k.get("minSpotColor") || (k.get("spotColor") && w[i] === this.miny)) && (M -= B.ceil(I)),
                                        (b || k.get("maxSpotColor") || (k.get("spotColor") && w[i] === this.maxy)) && ((M -= B.ceil(I)), (s += B.ceil(I))),
                                        (b || ((k.get("minSpotColor") || k.get("maxSpotColor")) && (w[0] === this.miny || w[0] === this.maxy))) && ((a += B.ceil(I)), (R -= B.ceil(I))),
                                        (b || k.get("spotColor") || k.get("minSpotColor") || (k.get("maxSpotColor") && (w[i] === this.miny || w[i] === this.maxy))) && (R -= B.ceil(I))),
                                    M--,
                                    k.get("normalRangeMin") === N || k.get("drawNormalOnTop") || this.drawNormalRange(a, s, M, R, e),
                                    o = [(r = [])],
                                    u = d = null,
                                    g = w.length,
                                    C = 0;
                                ...
                                (l = _[C]),
                                    (c = _[C + 1]),
                                    (h = w[C]),
                                    (d = (p = a + B.round((l - this.minx) * (R / t))) + ((C < g - 1 ? a + B.round((c - this.minx) * (R / t)) : R) - p) / 2),
                                    (H[C] = [u || 0, d, C]),
                                    (u = d),
                                    null === h
                                        ? C && (null !== w[C - 1] && ((r = []), o.push(r)), T.push(null))
                                        : (h < this.miny && (h = this.miny), h > this.maxy && (h = this.maxy), r.length || r.push([p, s + M]), (n = [p, s + B.round(M - M * ((h - this.miny) / e))]), r.push(n), T.push(n));
                            for (f = [], v = [], m = o.length, C = 0; C < m; C++)
                                (r = o[C]).length && (k.get("fillColor") && (r.push([r[r.length - 1][0], s + M]), v.push(r.slice(0)), r.pop()), 2 < r.length && (r[0] = [r[0][0], r[1][1]]), f.push(r));
                            ...
                            if (I && k.get("valueSpots"))
                                for ((y = k.get("valueSpots")).get === N && (y = new D(y)), C = 0; C < g; C++)
                                    (x = y.get(w[C])) && S.drawCircle(a + B.round((_[C] - this.minx) * (R / t)), s + B.round(M - M * ((w[C] - this.miny) / e)), I, N, x).append();
                            I && k.get("spotColor") && null !== w[i] && S.drawCircle(a + B.round((_[_.length - 1] - this.minx) * (R / t)), s + B.round(M - M * ((w[i] - this.miny) / e)), I, N, k.get("spotColor")).append(),
                                this.maxy !== this.minyorg &&
                                    (I &&
                                        k.get("minSpotColor") &&
                                        ((l = _[z.inArray(this.minyorg, w)]), S.drawCircle(a + B.round((l - this.minx) * (R / t)), s + B.round(M - M * ((this.minyorg - this.miny) / e)), I, N, k.get("minSpotColor")).append()),
                                    I &&
                                        k.get("maxSpotColor") &&
                                        ((l = _[z.inArray(this.maxyorg, w)]), S.drawCircle(a + B.round((l - this.minx) * (R / t)), s + B.round(M - M * ((this.maxyorg - this.miny) / e)), I, N, k.get("maxSpotColor")).append())),
                                (this.lastShapeId = S.getLastShapeId()),
                                (this.canvasTop = s),
                                S.render();
                        }
                    },
                ...
                (z.fn.sparkline.bar = O = e(z.fn.sparkline._base, a, {
                    ...
                    init: function (t, e, i, s, a) {
                        var n,
                            ...
                            A = 1 / 0,
                            P = -1 / 0;
                        for (O._super.init.call(this, t, e, i, s, a), c = 0, p = e.length; c < p; c++)
                            ((n = "string" == typeof (k = e[c]) && -1 < k.indexOf(":")) || z.isArray(k)) &&
                                ((b = !0), n && (k = e[c] = W(k.split(":"))), (k = L(k, null)), (r = B.min.apply(B, k)) < A && (A = r), P < (o = B.max.apply(B, k)) && (P = o));
                        (this.stacked = b),
                            (this.regionShapes = {}),
                            (this.barWidth = R),
                            (this.barSpacing = M),
                            (this.totalBarWidth = R + M),
                            (this.width = s = e.length * R + (e.length - 1) * M),
                            this.initTarget(),
                            H && ((m = T === N ? -1 / 0 : T), (y = I === N ? 1 / 0 : I)),
                            (h = []),
                            (l = b ? [] : h);
                        var q = [],
                            j = [];
                        for (c = 0, p = e.length; c < p; c++)
                            if (b)
                                for (x = e[c], e[c] = C = [], q[c] = 0, l[c] = j[c] = 0, _ = 0, w = x.length; _ < w; _++)
                                    null !== (k = C[_] = H ? E(x[_], m, y) : x[_]) && (0 < k && (q[c] += k), A < 0 && 0 < P ? (k < 0 ? (j[c] += B.abs(k)) : (l[c] += k)) : (l[c] += B.abs(k - (k < 0 ? P : A))), h.push(k));
                            else (k = H ? E(e[c], m, y) : e[c]), null !== (k = e[c] = F(k)) && h.push(k);
                        (this.max = v = B.max.apply(B, h)),
                            (this.min = f = B.min.apply(B, h)),
                            (this.stackMax = P = b ? B.max.apply(B, q) : v),
                            (this.stackMin = A = b ? B.min.apply(B, h) : f),
                            i.get("chartRangeMin") !== N && (i.get("chartRangeClip") || i.get("chartRangeMin") < f) && (f = i.get("chartRangeMin")),
                            i.get("chartRangeMax") !== N && (i.get("chartRangeClip") || i.get("chartRangeMax") > v) && (v = i.get("chartRangeMax")),
                            (this.zeroAxis = d = i.get("zeroAxis", !0)),
                            (g = f <= 0 && 0 <= v && d ? 0 : 0 == d ? f : 0 < f ? f : v),
                            (this.xaxisOffset = g),
                            (u = b ? B.max.apply(B, l) + B.max.apply(B, j) : v - f),
                            (this.canvasHeightEf = d && f < 0 ? this.canvasHeight - 2 : this.canvasHeight - 1),
                            f < g ? (S = (((b && 0 <= v ? P : v) - g) / u) * this.canvasHeight) !== B.ceil(S) && ((this.canvasHeightEf -= 2), (S = B.ceil(S))) : (S = this.canvasHeight),
                            (this.yoffset = S),
                            z.isArray(i.get("colorMap"))
                                ? ((this.colorMapByIndex = i.get("colorMap")), (this.colorMapByValue = null))
                                : ((this.colorMapByIndex = null), (this.colorMapByValue = i.get("colorMap")), this.colorMapByValue && this.colorMapByValue.get === N && (this.colorMapByValue = new D(this.colorMapByValue))),
                            (this.range = u);
                    },
                    getRegion: function (t, e, i) {
                    ...
                    getCurrentRegionFields: function () {
                        var t,
                            ...
                            s = n(this.values[i]),
                            a = [];
                        for (e = s.length; e--; ) (t = s[e]), a.push({ isNull: null === t, value: t, color: this.calcColor(e, t, i), offset: i });
                        return a;
                    },
                    calcColor: function (t, e, i) {
                        var s,
                            ...
                            o = this.options;
                        return (
                            (s = this.stacked ? o.get("stackedBarColor") : e < 0 ? o.get("negBarColor") : o.get("barColor")),
                            0 === e && o.get("zeroColor") !== N && (s = o.get("zeroColor")),
                            r && (a = r.get(e)) ? (s = a) : n && n.length > i && (s = n[i]),
                            z.isArray(s) ? s[t % s.length] : s
                        );
                    },
                    renderRegion: function (t, e) {
                        var i,
                            ...
                            _ = this.yoffset;
                        if (((l = (u = z.isArray(u) ? u : [u]).length), (h = u[0]), (n = w(null, u)), (p = w(g, u, !0)), n))
                            return d.get("nullColor") ? ((a = e ? d.get("nullColor") : this.calcHighlightColor(d.get("nullColor"), d)), (i = 0 < _ ? _ - 1 : _), y.drawRect(b, i, this.barWidth - 1, 0, a, a)) : N;
                        for (r = _, o = 0; o < l; o++) {
                            if (((h = u[o]), m && h === g)) {
                                if (!p || c) continue;
                                c = !0;
                            }
                            (s = 0 < v ? B.floor(x * (B.abs(h - g) / v)) + 1 : 1),
                                h < g || (h === g && 0 === _) ? ((i = r), (r += s)) : ((i = _ - s), (_ -= s)),
                                (a = this.calcColor(o, h, t)),
                                e && (a = this.calcHighlightColor(a, d)),
                                f.push(y.drawRect(b, i, this.barWidth - 1, s - 1, a, a));
                        }
                ...
                (z.fn.sparkline.tristate = o = e(z.fn.sparkline._base, a, {
                    ...
                    init: function (t, e, i, s, a) {
                        ...
                        o._super.init.call(this, t, e, i, s, a),
                            (this.regionShapes = {}),
                            (this.barWidth = n),
                            (this.barSpacing = r),
                            (this.totalBarWidth = n + r),
                            (this.values = z.map(e, Number)),
                            (this.width = s = e.length * n + (e.length - 1) * r),
                            z.isArray(i.get("colorMap"))
                                ? ((this.colorMapByIndex = i.get("colorMap")), (this.colorMapByValue = null))
                                : ((this.colorMapByIndex = null), (this.colorMapByValue = i.get("colorMap")), this.colorMapByValue && this.colorMapByValue.get === N && (this.colorMapByValue = new D(this.colorMapByValue))),
                            this.initTarget();
                    ...
                    getCurrentRegionFields: function () {
                        var t = this.currentRegion;
                        return { isNull: this.values[t] === N, value: this.values[t], color: this.calcColor(this.values[t], t), offset: t };
                    },
                    ...
                    renderRegion: function (t, e) {
                        var i,
                            ...
                            h = this.options,
                            c = this.target;
                        if (((i = c.pixelHeight), (a = B.round(i / 2)), (n = t * this.totalBarWidth), l[t] < 0 ? (s = (r = a) - 1) : 0 < l[t] ? ((r = 0), (s = a - 1)) : ((r = a - 1), (s = 2)), null !== (o = this.calcColor(l[t], t))))
                            return e && (o = this.calcHighlightColor(o, h)), c.drawRect(n, r, this.barWidth - 1, s - 1, o, o);
                    },
                })),
                (z.fn.sparkline.discrete = r = e(z.fn.sparkline._base, a, {
                    type: "discrete",
                    init: function (t, e, i, s, a) {
                        r._super.init.call(this, t, e, i, s, a),
                            (this.regionShapes = {}),
                            (this.values = e = z.map(e, Number)),
                            (this.min = B.min.apply(B, e)),
                            (this.max = B.max.apply(B, e)),
                            (this.range = this.max - this.min),
                            (this.width = s = "auto" === i.get("width") ? 2 * e.length : this.width),
                            (this.interval = B.floor(s / e.length)),
                            (this.itemWidth = s / e.length),
                            i.get("chartRangeMin") !== N && (i.get("chartRangeClip") || i.get("chartRangeMin") < this.min) && (this.min = i.get("chartRangeMin")),
                            i.get("chartRangeMax") !== N && (i.get("chartRangeClip") || i.get("chartRangeMax") > this.max) && (this.max = i.get("chartRangeMax")),
                            this.initTarget(),
                            this.target && (this.lineHeight = "auto" === i.get("lineHeight") ? B.round(0.3 * this.canvasHeight) : i.get("lineHeight"));
                    },
                    getRegion: function (t, e, i) {
                    ...
                    renderRegion: function (t, e) {
                        ...
                        return (
                            ...
                            (n = t * p),
                            (i = B.round(f - f * ((s - l) / c))),
                            (a = o.get("thresholdColor") && s < o.get("thresholdValue") ? o.get("thresholdColor") : o.get("lineColor")),
                            e && (a = this.calcHighlightColor(a, o)),
                            u.drawLine(n, i, n, i + g, a)
                        );
                    },
                })),
                (z.fn.sparkline.bullet = l = e(z.fn.sparkline._base, {
                    ...
                    init: function (t, e, i, s, a) {
                        var n, r, o;
                        l._super.init.call(this, t, e, i, s, a),
                            (this.values = e = W(e)),
                            ((o = e.slice())[0] = null === o[0] ? o[2] : o[0]),
                            (o[1] = null === e[1] ? o[2] : o[1]),
                            (n = B.min.apply(B, e)),
                            (r = B.max.apply(B, e)),
                            (n = i.get("base") === N ? (n < 0 ? n : 0) : i.get("base")),
                            (this.min = n),
                            (this.max = r),
                            (this.range = r - n),
                            (this.shapes = {}),
                            ...
                            (this.target = this.$el.simpledraw(s, a, i.get("composite"))),
                    ...
                    renderPerformance: function (t) {
                        ...
                        return t && (s = this.calcHighlightColor(s, this.options)), this.target.drawRect(0, B.round(0.3 * this.canvasHeight), i - 1, B.round(0.4 * this.canvasHeight) - 1, s, s);
                    },
                    renderTarget: function (t) {
                        var e = this.values[0],
                            i = B.round(this.canvasWidth * ((e - this.min) / this.range) - this.options.get("targetWidth") / 2),
                            s = B.round(0.1 * this.canvasHeight),
                    ...
                    render: function () {
                        ...
                        if (l._super.render.call(this)) {
                            ...
                            null !== this.values[1] && ((e = this.renderPerformance().append()), (this.shapes[e.id] = "p1"), (this.valueShapes.p1 = e.id)),
                                null !== this.values[0] && ((e = this.renderTarget().append()), (this.shapes[e.id] = "t0"), (this.valueShapes.t0 = e.id)),
                                s.render();
                        }
                    },
                })),
                (z.fn.sparkline.pie = h = e(z.fn.sparkline._base, {
                    ...
                    getCurrentRegionFields: function () {
                        var t = this.currentRegion;
                        return { isNull: this.values[t] === N, value: this.values[t], percent: (this.values[t] / this.total) * 100, color: this.options.get("sliceColors")[t % this.options.get("sliceColors").length], offset: t };
                    },
                    changeHighlight: function (t) {
                    ...
                    renderSlice: function (t, e) {
                        ...
                        for (n = d.length, a = 0; a < n; a++) {
                            if (((s = i = f), 0 < g && (s = f + u * (d[a] / g)), t === a))
                                return (r = l.get("sliceColors")[a % l.get("sliceColors").length]), e && (r = this.calcHighlightColor(r, l)), o.drawPieSlice(h, h, h - c, i, s, N, r);
                            f = s;
                        }
                    },
                    render: function () {
                ...
                (z.fn.sparkline.box = _ = e(z.fn.sparkline._base, {
                    ...
                    getCurrentRegionFields: function () {
                        ...
                        return (
                            this.loutlier !== N && t.push({ field: "lo", value: this.loutlier }),
                            this.routlier !== N && t.push({ field: "ro", value: this.routlier }),
                            this.lwhisker !== N && t.push({ field: "lw", value: this.lwhisker }),
                            this.rwhisker !== N && t.push({ field: "rw", value: this.rwhisker }),
                            t
                        );
                    },
                    render: function () {
                        ...
                        if (_._super.render.call(this)) {
                            ...
                            (this.quartiles = [s, a, n]),
                                ...
                                (c = f / (y - m + 1)),
                                g.get("showOutliers") &&
                                    ((b = B.ceil(g.get("spotRadius"))),
                                    (c = (f -= 2 * B.ceil(g.get("spotRadius"))) / (y - m + 1)),
                                    e < t && p.drawCircle((e - m) * c + b, v / 2, g.get("spotRadius"), g.get("outlierLineColor"), g.get("outlierFillColor")).append(),
                                    r < o && p.drawCircle((o - m) * c + b, v / 2, g.get("spotRadius"), g.get("outlierLineColor"), g.get("outlierFillColor")).append()),
                                p.drawRect(B.round((s - m) * c + b), B.round(0.1 * v), B.round((n - s) * c), B.round(0.8 * v), g.get("boxLineColor"), g.get("boxFillColor")).append(),
                                p.drawLine(B.round((t - m) * c + b), B.round(v / 2), B.round((s - m) * c + b), B.round(v / 2), g.get("lineColor")).append(),
                                p.drawLine(B.round((t - m) * c + b), B.round(v / 4), B.round((t - m) * c + b), B.round(v - v / 4), g.get("whiskerColor")).append(),
                                p.drawLine(B.round((r - m) * c + b), B.round(v / 2), B.round((n - m) * c + b), B.round(v / 2), g.get("lineColor")).append(),
                                p.drawLine(B.round((r - m) * c + b), B.round(v / 4), B.round((r - m) * c + b), B.round(v - v / 4), g.get("whiskerColor")).append(),
                                p.drawLine(B.round((a - m) * c + b), B.round(0.1 * v), B.round((a - m) * c + b), B.round(0.9 * v), g.get("medianColor")).append(),
                                g.get("target") &&
                                    ((h = B.ceil(g.get("spotRadius"))),
                                    p.drawLine(B.round((g.get("target") - m) * c + b), B.round(v / 2 - h), B.round((g.get("target") - m) * c + b), B.round(v / 2 + h), g.get("targetColor")).append(),
                                    p.drawLine(B.round((g.get("target") - m) * c + b - h), B.round(v / 2), B.round((g.get("target") - m) * c + b + h), B.round(v / 2), g.get("targetColor")).append()),
                                p.render();
                        }
                    },
                })),
                ...
                (f = e(g, {
                    init: function (t, e, i, s) {
                        f._super.init.call(this, t, e, i),
                            ...
                            i[0] && (i = i[0]),
                            z.data(i, "_jqs_vcanvas", this),
                            z(this.canvas).css({ display: "inline-block", width: t, height: e, verticalAlign: "top" }),
                            ...
                            z(this.canvas).css({ width: this.pixelWidth, height: this.pixelHeight });
                    },
                    ...
                    _drawShape: function (t, e, i, s, a) {
                        var n,
                            r,
                            o = this._getContext(i, s, a);
                        for (o.beginPath(), o.moveTo(e[0][0] + 0.5, e[0][1] + 0.5), n = 1, r = e.length; n < r; n++) o.lineTo(e[n][0] + 0.5, e[n][1] + 0.5);
                    ...
                    _drawPieSlice: function (t, e, i, s, a, n, r, o) {
                        ...
                        l.beginPath(),
                            ...
                            r !== N && l.stroke(),
                            o && l.fill(),
                            this.targetX !== N && this.targetY !== N && l.isPointInPath(this.targetX, this.targetY) && (this.currentTargetShapeId = t);
                    },
                ...
                (v = e(g, {
                    init: function (t, e, i) {
                        ...
                        v._super.init.call(this, t, e, i),
                            i[0] && (i = i[0]),
                            z.data(i, "_jqs_vcanvas", this),
                            (this.canvas = k.createElement("span")),
                            z(this.canvas).css({ display: "inline-block", position: "relative", overflow: "hidden", width: t, height: e, margin: "0px", padding: "0px", verticalAlign: "top" }),
                            this._insert(this.canvas, i),
                            this._calculatePixelDims(t, e, this.canvas),
                            (this.canvas.width = this.pixelWidth),
                            (this.canvas.height = this.pixelHeight),
                            ...
                            (this.group = z(this.canvas).children()[0]),
                            (this.rendered = !1),
                            (this.prerender = "");
                    },
                    _drawShape: function (t, e, i, s, a) {
                        ...
                        return (
                            (n = p.splice(0, 1)),
                            (a = a === N ? 1 : a),
                            (r = i === N ? ' stroked="false" ' : ' strokeWeight="' + a + 'px" strokeColor="' + i + '" '),
                            (o = s === N ? ' filled="false"' : ' fillColor="' + s + '" filled="true" '),
                            (l = p[0] === p[p.length - 1] ? "x " : ""),
                    ...
                    _drawCircle: function (t, e, i, s, a, n, r) {
                        return (
                            ...
                            t +
                            '" ' +
                            (a === N ? ' stroked="false" ' : ' strokeWeight="' + r + 'px" strokeColor="' + a + '" ') +
                            (n === N ? ' filled="false"' : ' fillColor="' + n + '" filled="true" ') +
                    ...
                    _drawPieSlice: function (t, e, i, s, a, n, r, o) {
                        ...
                        return h === p && c === u && n - a < B.PI
                            ? ""
                            : ((l = [e - s, i - s, e + s, i + s, h, c, p, u]),
                              (d = r === N ? ' stroked="false" ' : ' strokeWeight="1px" strokeColor="' + r + '" '),
                              (g = o === N ? ' filled="false"' : ' fillColor="' + o + '" filled="true" '),
                              '<v:shape coordorigin="0 0" coordsize="' +
                                  this.pixelWidth +
                                  " " +
                                  this.pixelHeight +
...
var pJS = function (t, e) {
    ...
    e && Object.deepExtend(d, e),
        ...
        (d.fn.retinaInit = function () {
            d.retina_detect && 1 < window.devicePixelRatio ? ((d.canvas.pxratio = window.devicePixelRatio), (d.tmp.retina = !0)) : ((d.canvas.pxratio = 1), (d.tmp.retina = !1)),
                ...
                d &&
                    ...
                    window.addEventListener("resize", function () {
                        (d.canvas.w = d.canvas.el.offsetWidth),
                            ...
                            d.tmp.retina && ((d.canvas.w *= d.canvas.pxratio), (d.canvas.h *= d.canvas.pxratio)),
                            (d.canvas.el.width = d.canvas.w),
                            (d.canvas.el.height = d.canvas.h),
                            d.particles.move.enable || (d.fn.particlesEmpty(), d.fn.particlesCreate(), d.fn.particlesDraw(), d.fn.vendors.densityAutoParticles()),
        ...
        (d.fn.particle = function (t, e, i) {
            if (
                ((this.radius = (d.particles.size.random ? Math.random() : 1) * d.particles.size.value),
                d.particles.size.anim.enable && ((this.size_status = !1), (this.vs = d.particles.size.anim.speed / 100), d.particles.size.anim.sync || (this.vs = this.vs * Math.random())),
                (this.x = i ? i.x : Math.random() * d.canvas.w),
                (this.y = i ? i.y : Math.random() * d.canvas.h),
                ...
                d.particles.move.bounce && d.fn.vendors.checkOverlap(this, i),
                (this.color = {}),
                ...
                if (t.value instanceof Array) {
                    ...
                    null != t.value.r && null != t.value.g && null != t.value.b && (this.color.rgb = { r: t.value.r, g: t.value.g, b: t.value.b }),
                        null != t.value.h && null != t.value.s && null != t.value.l && (this.color.hsl = { h: t.value.h, s: t.value.s, l: t.value.l });
            else
                "random" == t.value
            ...
            (this.opacity = (d.particles.opacity.random ? Math.random() : 1) * d.particles.opacity.value),
                d.particles.opacity.anim.enable && ((this.opacity_status = !1), (this.vo = d.particles.opacity.anim.speed / 100), d.particles.opacity.anim.sync || (this.vo = this.vo * Math.random()));
            var a = {};
            ...
            d.particles.move.straight
                ? ((this.vx = a.x), (this.vy = a.y), d.particles.move.random && ((this.vx = this.vx * Math.random()), (this.vy = this.vy * Math.random())))
                : ((this.vx = a.x + Math.random() - 0.5), (this.vy = a.y + Math.random() - 0.5)),
                (this.vx_i = this.vx),
                (this.vy_i = this.vy);
            ...
            if ("image" == this.shape) {
                ...
                (this.img = { src: o.image.src, ratio: o.image.width / o.image.height }),
                    ...
                    "svg" == d.tmp.img_type && null != d.tmp.source_svg && (d.fn.vendors.createSvgImg(this), d.tmp.pushing && (this.img.loaded = !1));
            }
        }),
        (d.fn.particle.prototype.draw = function () {
            ...
            switch (((d.canvas.ctx.fillStyle = s), d.canvas.ctx.beginPath(), t.shape)) {
                ...
                case "triangle":
                    ...
                    break;
                case "polygon":
                    d.fn.vendors.drawShape(d.canvas.ctx, t.x - e / (d.particles.shape.polygon.nb_sides / 3.5), t.y - e / 0.76, (2.66 * e) / (d.particles.shape.polygon.nb_sides / 3), d.particles.shape.polygon.nb_sides, 1);
                    break;
                case "star":
            ...
            d.canvas.ctx.closePath(),
                0 < d.particles.shape.stroke.width && ((d.canvas.ctx.strokeStyle = d.particles.shape.stroke.color), (d.canvas.ctx.lineWidth = d.particles.shape.stroke.width), d.canvas.ctx.stroke()),
                d.canvas.ctx.fill();
        }),
            ...
            for (var t = 0; t < d.particles.array.length; t++) {
                ...
                if (
                    (d.particles.opacity.anim.enable &&
                        (1 == e.opacity_status ? (e.opacity >= d.particles.opacity.value && (e.opacity_status = !1), (e.opacity += e.vo)) : (e.opacity <= d.particles.opacity.anim.opacity_min && (e.opacity_status = !0), (e.opacity -= e.vo)),
                        e.opacity < 0 && (e.opacity = 0)),
                    d.particles.size.anim.enable &&
                        (1 == e.size_status ? (e.radius >= d.particles.size.value && (e.size_status = !1), (e.radius += e.vs)) : (e.radius <= d.particles.size.anim.size_min && (e.size_status = !0), (e.radius -= e.vs)),
                        e.radius < 0 && (e.radius = 0)),
                    "bounce" == d.particles.move.out_mode)
                )
                    var s = { x_left: e.radius, x_right: d.canvas.w, y_top: e.radius, y_bottom: d.canvas.h };
                else s = { x_left: -e.radius, x_right: d.canvas.w + e.radius, y_top: -e.radius, y_bottom: d.canvas.h + e.radius };
                switch (
                    (e.x - e.radius > d.canvas.w ? ((e.x = s.x_left), (e.y = Math.random() * d.canvas.h)) : e.x + e.radius < 0 && ((e.x = s.x_right), (e.y = Math.random() * d.canvas.h)),
                    e.y - e.radius > d.canvas.h ? ((e.y = s.y_top), (e.x = Math.random() * d.canvas.w)) : e.y + e.radius < 0 && ((e.y = s.y_bottom), (e.x = Math.random() * d.canvas.w)),
                ...
                if (
                    (isInArray("grab", d.interactivity.events.onhover.mode) && d.fn.modes.grabParticle(e),
                    (isInArray("bubble", d.interactivity.events.onhover.mode) || isInArray("bubble", d.interactivity.events.onclick.mode)) && d.fn.modes.bubbleParticle(e),
                    (isInArray("repulse", d.interactivity.events.onhover.mode) || isInArray("repulse", d.interactivity.events.onclick.mode)) && d.fn.modes.repulseParticle(e),
        ...
        (d.fn.interact.linkParticles = function (t, e) {
            ...
            if (a <= d.particles.line_linked.distance) {
                ...
                if (0 < n) {
                    ...
                    (d.canvas.ctx.strokeStyle = "rgba(" + r.r + "," + r.g + "," + r.b + "," + n + ")"),
                        (d.canvas.ctx.lineWidth = d.particles.line_linked.width),
                        d.canvas.ctx.beginPath(),
                        d.canvas.ctx.moveTo(t.x, t.y),
                        d.canvas.ctx.lineTo(e.x, e.y),
                        d.canvas.ctx.stroke(),
                        d.canvas.ctx.closePath();
                }
            }
        ...
        (d.fn.modes.pushParticles = function (t, e) {
            d.tmp.pushing = !0;
            for (var i = 0; i < t; i++)
                d.particles.array.push(new d.fn.particle(d.particles.color, d.particles.opacity.value, { x: e ? e.pos_x : Math.random() * d.canvas.w, y: e ? e.pos_y : Math.random() * d.canvas.h })),
        ...
        (d.fn.modes.bubbleParticle = function (o) {
            ...
            if (d.interactivity.events.onhover.enable && isInArray("bubble", d.interactivity.events.onhover.mode)) {
                ...
                d.tmp.bubble_clicking &&
                    (e(d.interactivity.modes.bubble.size, d.particles.size.value, o.radius_bubble, o.radius, "size"), e(d.interactivity.modes.bubble.opacity, d.particles.opacity.value, o.opacity_bubble, o.opacity, "opacity"));
            }
        }),
            ...
            if (d.interactivity.events.onhover.enable && "mousemove" == d.interactivity.status) {
                ...
                if (s <= d.interactivity.modes.grab.distance) {
                    ...
                    if (0 < a) {
                        ...
                        (d.canvas.ctx.strokeStyle = "rgba(" + n.r + "," + n.g + "," + n.b + "," + a + ")"),
                            (d.canvas.ctx.lineWidth = d.particles.line_linked.width),
                            d.canvas.ctx.beginPath(),
                            d.canvas.ctx.moveTo(t.x, t.y),
        ...
        (d.fn.vendors.eventsListeners = function () {
            "window" == d.interactivity.detect_on ? (d.interactivity.el = window) : (d.interactivity.el = d.canvas.el),
                (d.interactivity.events.onhover.enable || d.interactivity.events.onclick.enable) &&
                    (d.interactivity.el.addEventListener("mousemove", function (t) {
                        if (d.interactivity.el == window)
                            var e = t.clientX,
                                i = t.clientY;
                        else (e = t.offsetX || t.clientX), (i = t.offsetY || t.clientY);
                        (d.interactivity.mouse.pos_x = e),
                            (d.interactivity.mouse.pos_y = i),
                            d.tmp.retina && ((d.interactivity.mouse.pos_x *= d.canvas.pxratio), (d.interactivity.mouse.pos_y *= d.canvas.pxratio)),
                ...
                d.interactivity.events.onclick.enable &&
                    d.interactivity.el.addEventListener("click", function () {
                        if (
                            ((d.interactivity.mouse.click_pos_x = d.interactivity.mouse.pos_x),
                            ...
                            switch (d.interactivity.events.onclick.mode) {
                                case "push":
                                    d.particles.move.enable
                                        ? d.fn.modes.pushParticles(d.interactivity.modes.push.particles_nb, d.interactivity.mouse)
                                        : 1 == d.interactivity.modes.push.particles_nb
                                        ? d.fn.modes.pushParticles(d.interactivity.modes.push.particles_nb, d.interactivity.mouse)
                                        : 1 < d.interactivity.modes.push.particles_nb && d.fn.modes.pushParticles(d.interactivity.modes.push.particles_nb);
                                    break;
                                case "remove":
        ...
        (d.fn.vendors.loadImg = function (t) {
            if (((d.tmp.img_error = void 0), "" != d.particles.shape.image.src))
                if ("svg" == t) {
                    ...
                    e.open("GET", d.particles.shape.image.src),
            ...
            "image" == d.particles.shape.type
                ? "svg" == d.tmp.img_type
                    ? d.tmp.count_svg >= d.particles.number.value
                        ? (d.fn.particlesDraw(), d.particles.move.enable ? (d.fn.drawAnimFrame = requestAnimFrame(d.fn.vendors.draw)) : cancelRequestAnimFrame(d.fn.drawAnimFrame))
                        : d.tmp.img_error || (d.fn.drawAnimFrame = requestAnimFrame(d.fn.vendors.draw))
                    : null != d.tmp.img_obj
                    ? (d.fn.particlesDraw(), d.particles.move.enable ? (d.fn.drawAnimFrame = requestAnimFrame(d.fn.vendors.draw)) : cancelRequestAnimFrame(d.fn.drawAnimFrame))
                    : d.tmp.img_error || (d.fn.drawAnimFrame = requestAnimFrame(d.fn.vendors.draw))
                : (d.fn.particlesDraw(), d.particles.move.enable ? (d.fn.drawAnimFrame = requestAnimFrame(d.fn.vendors.draw)) : cancelRequestAnimFrame(d.fn.drawAnimFrame));
        ...
        (d.fn.vendors.checkBeforeDraw = function () {
            "image" == d.particles.shape.type
                ? "svg" == d.tmp.img_type && null == d.tmp.source_svg
                    ...
                    : (cancelRequestAnimFrame(d.tmp.checkAnimFrame), d.tmp.img_error || (d.fn.vendors.init(), d.fn.vendors.draw()))
