...
$(function () {
    ...
    $(document).ready(function () {
        $("#main-menu").metisMenu(),
            $("#left-sidebar .sidebar-scroll").slimScroll({ height: "calc(100vh - 65px)", wheelStep: 10, touchScrollStep: 50, color: "#1c222c", size: "2px", borderRadius: "3px", alwaysVisible: !1, position: "right" }),
            ...
            $(".checkbox-tick").on("click", function () {
                $(this).parents(".check-all-parent").find(".checkbox-tick:checked").length == $(this).parents(".check-all-parent").find(".checkbox-tick").length
                    ? $(this).parents(".check-all-parent").find(".check-all").prop("checked", !0)
                    : $(this).parents(".check-all-parent").find(".check-all").prop("checked", !1);
            }),
            ...
            $(".setting_switch .mini-sidebar-btn").on("change", function () {
                this.checked
                    ? ($("body").addClass("mini_sidebar"), $("#left-sidebar").addClass("mini_sidebar_on"), $(".hmenu-btn").attr("disabled", "disabled"))
                    : ($("body").removeClass("mini_sidebar"), $("#left-sidebar").removeClass("mini_sidebar_on"), $(".hmenu-btn").removeAttr("disabled", "disabled"));
            }),
    ...
    //         color: { value: ["#fc3c5f", "#993cfc", "#3ca9fc", "#3cfc5f", "#fcdf3c"] },
    //         shape: { type: "circle", stroke: { width: 0, color: "#000000" }, polygon: { nb_sides: 15 } },
    //         opacity: { value: 0.5, random: !1, anim: { enable: !1, speed: 1.2, opacity_min: 0.15, sync: !1 } },
    //         size: { value: 2.5, random: !1, anim: { enable: !0, speed: 2, size_min: 0.15, sync: !1 } },
    //         line_linked: { enable: !0, distance: 110, color: "#2b313c", opacity: 1, width: 1 },
    //         move: { enable: !0, speed: 1.6, direction: "none", random: !1, straight: !1, out_mode: "out", bounce: !1, attract: { enable: !1, rotateX: 600, rotateY: 1200 } },
    //     },
    //     interactivity: {
    //         detect_on: "canvas",
