  ...
  var swiper2 = new Swiper("#testSlider", {
    slidesPerView: 1,
    spaceBetween: 10,
    navigation: {
 ...
 //   $(document).on("select2:open", () => {
  ...
  var swiper3 = new Swiper("#productSlider", {
    slidesPerView: 1,
    spaceBetween: 10,
    navigation: {
      nextEl: ".swiper-button-next",
...
function formatPrice(price){
    ...
    $('#price').focus();
    $('#price')[0].setSelectionRange(strLength, strLength);
...
// $('.customForm .select2-selection').click(function(){
