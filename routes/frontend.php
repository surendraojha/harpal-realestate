...
use App\Http\Controllers\Front\AgentAgencyController;
...
Route::get('agent-list', [AgentAgencyController::class, 'agentList'])
    ->name('front.agent-list');

Route::get('agent-detail/{id}', [AgentAgencyController::class, 'agentDetail'])
    ->name('front.agent-detail');

Route::get('agency-list', [AgentAgencyController::class, 'agencyList'])
    ->name('front.agency-list');

Route::get('agency-detail/{id}', [AgentAgencyController::class, 'agencyDetail'])
    ->name('front.agency-detail');

Route::get('get-custom-fields', [AjaxController::class, 'getCustomField'])
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('user-upgrade', [ProfileController::class, 'requestUpgradeForm'])
        ->name('user-upgrade');
    Route::post('user-upgrade-post', [ProfileController::class, 'requestUpgrade'])
        ->name('user-upgrade.post');
