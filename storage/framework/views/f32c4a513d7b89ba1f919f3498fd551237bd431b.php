            ...
            <div class="col-md-4 mb-3">
                <div class="form-floating customForm">
                    <input type="text" name="shitting_room"
                        class="form-control <?php echo e($errors->has('shitting_room') ? ' is-invalid' : ''); ?>" id="shitting_room"
                        placeholder="eg. 1,2,3 .." value="<?php echo e(old('shitting_room', @$information->shitting_room)); ?>">
...
<?php /**PATH E:\xampp\htdocs\harpal-realestate\resources\views/admin/residental-property/form.blade.php ENDPATH**/ ?>