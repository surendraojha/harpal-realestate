...
<?php endif; ?>
                                                        ...
                                                        <td>
                                                            <img height="35px" width="35px"
                                                                src="<?php echo e(asset('blogs/' . $value->photo)); ?>"
                                                                alt="No Photo">
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?php echo e(route('blog.edit', $value->id)); ?>"> <i
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\harpal-realestate\resources\views/admin/blog/index.blade.php ENDPATH**/ ?>