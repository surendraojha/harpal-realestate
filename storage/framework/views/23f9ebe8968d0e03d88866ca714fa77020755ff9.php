    ...
    <div id="main-content">
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-12">
                    <div class="card">
                        <form action="<?php echo e(route('meta-tag.index')); ?>" method="get">
                            <div class="body">
                                <div class="row">
                    ...
                    <div class="card">
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a class="nav-link <?php if(!session()->get('errors')): ?> active show <?php endif; ?>"
                                    data-toggle="tab" href="#Users">Meta Tags
                                </a></li>
                            <li class="nav-item"><a class="nav-link <?php if(session()->get('errors')): ?> active show <?php endif; ?>"
                                    data-toggle="tab" href="#addUser">Add Meta Tag
                                </a></li>
                        </ul>
...
<?php endif; ?>
                                                        ...
                                                        <td><?php echo e($value->meta_keyword); ?></td>
                                                        <td><?php echo e(date('d M, Y', strtotime($value->created_at))); ?></td>
                                                        <td>

                                                            <a href="<?php echo e(route('meta-tag.edit', $value->id)); ?>"> <i
...
<?php endif; ?>
                            ...
                            <div class="tab-pane <?php if(session()->get('errors')): ?> active show <?php endif; ?>" id="addUser">
                                <div class="body mt-2">
                                    ...
                                    <?php echo Form::open(['route' => 'meta-tag.store', 'method' => 'post', 'files' => true]); ?>


                                    <?php echo csrf_field(); ?>
                                    <?php echo $__env->make('admin.meta-tag.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">Add</button>
                                        <a class="btn btn-secondary" href="<?php echo e(route('meta-tag.index')); ?>">
                                            Close
                                        </a>
                                    </div>
                                    <?php echo Form::close(); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\kotha-bhada\resources\views/admin/meta-tag/index.blade.php ENDPATH**/ ?>