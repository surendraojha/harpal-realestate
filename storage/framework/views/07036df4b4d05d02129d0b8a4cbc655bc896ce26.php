        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <ul>
                    ...
                    <?php $__currentLoopData = $most_searched_locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="<?php echo e(route('front.location',$value->location)); ?>">
            ...
            <div class="col-md-3">
                ...
                <ul class="impLinks">
                    <?php $__currentLoopData = $quick_links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
            ...
            <div class="col-md-3">
                ...
                <ul>
                    ...
                    <li>
                        <a href="<?php echo e(route('front.top-rated')); ?>">
                             Most Viewed
                        </a>
                    </li>
                    <li>
            ...
            <div class="col-md-3">
                ...
                <ul>
                    ...
                    <li>
                        <a href="mail-to:<?php echo e($setting->email); ?>">
                            <!-- Generator: Adobe Illustrator 22.0.1, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
                ...
                <ul class="contactForAdvetisement">
                    <li>
                        <a href="<?php echo e(route('front.contact-us')); ?>">
                            Contact Us
                        </a>
                    </li>
                </ul>
                <ul class="top-header-social-icons">
                    <li><a href="<?php echo e($setting->facebook); ?>" target="_blank" data-toggle="tooltip" data-placement="top" title="" data-original-title="Facebook"><i class="fab fa-facebook"></i></a></li>
                    <li><a href="<?php echo e($setting->twitter); ?>" target="_blank" data-toggle="tooltip" data-placement="top" title="" data-original-title="Twitter"><i class="fab fa-twitter"></i></a></li>
                    <li><a href="<?php echo e(@$setting->youtube); ?>" target="_blank" data-toggle="tooltip" data-placement="top" title="" data-original-title="Youtube"><i class="fab fa-youtube"></i></a></li>
                    <li><a href="<?php echo e(@$setting->linkedin); ?>" target="_blank" data-toggle="tooltip" data-placement="top" title="" data-original-title="Linkedin"><i class="fab fa-linkedin"></i></a></li>
                    <li><a href="<?php echo e(@$setting->tiktok); ?>" target="_blank" data-toggle="tooltip" data-placement="top" title="" data-original-title="Tiktok"><i class="fab fa-tiktok"></i></a></li>
                    <li><a href="<?php echo e(@$setting->instagram); ?>" target="_blank" data-toggle="tooltip" data-placement="top" title="" data-original-title="Instagram"><i class="fab fa-instagram"></i></a></li>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 text-center mb-3 pt-4">
                    <p>
                       <?php echo $setting->choose_property_text; ?>
                ...
                <div class="col-md-6 text-center pt-4">
                    <div class="newsLetter">
                        ...
                        <form action="<?php echo e(route('newsletter.post')); ?>" method="post">
                            <?php echo csrf_field(); ?>
    ...
    <div class="copyrightFooter pt-5 pb-3">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p>
                        1992-<?php echo e(date('Y')); ?>. All rights reserved to Kotha Bhada.com
                    </p>
                </div>
...
<div class="offcanvas offcanvas-start" tabindex="" id="mobileMenuBox" aria-labelledby="mobileMenuBoxLabel">
    <nav class="siteNav">
        ...
        <a href="<?php echo e(route('front.home')); ?>" class="logo">
            <div>
                <img src="<?php echo e(asset('uploads/'.$setting->company_logo)); ?>" alt="<?php echo e($setting->company_name); ?>"  width="151" height="28">
            </div>
        </a>
        <ul>
...
<?php /**PATH E:\xampp\htdocs\harpal-realestate\resources\views/front/layouts/footer.blade.php ENDPATH**/ ?>