    ...
    <div id="main-content">
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-12">
                    <div class="card">
                        <form action="<?php echo e(route('admin-commercial-property.index')); ?>" method="get">
                            <div class="body">
                                <div class="row">
...
<?php endif; ?>
                                        ...
                                        <p class="pt-3">
                                            <b>
                                                ...
                                                Showing <?php echo e($showing - $per_page + 1); ?> to <?php if($showing < $count): ?>
                                                    <?php echo e($showing); ?>

                                                <?php else: ?>
                                                    <?php echo e($count); ?>

                                                <?php endif; ?> of <?php echo e($count); ?> entries
                                            </b>
                                        </p>
...
<?php endif; ?>
                                                        ...
                                                        <td>
                                                            <a target="_blank"
                                                                href="<?php echo e(route('property.detail', $value->slug)); ?>">
                                                        ...
                                                        <td>
                                                            <p><strong>Location:</strong><?php echo e($value->location->location); ?>

                                                            </p>

                                                            <p><Strong>Category: </Strong><?php echo e($value->subcategory->title); ?>
                                                        ...
                                                        <td>
                                                            <a target="_blank"
                                                                href="<?php echo e(route('view.profile', $value->user->email)); ?>">
                                                        ...
                                                        <td>
                                                            <a
                                                                href="<?php echo e(route('admin-commercial-property.edit', $value->id)); ?>">
...
<?php endif; ?>
                            ...
                            <div class="tab-pane <?php if(session()->get('errors')): ?> active show <?php endif; ?>" id="addUser">
                                <div class="body mt-2">
                                    ...
                                    <?php echo Form::open([
                                        'route' => 'admin-commercial-property.store',
                                        'method' => 'post',
                                        'files' => true,
                                        'id' => 'property-form',
                                    ]); ?>
                                    ...
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary"
                                            onclick="event.preventDefault();validateCommercialForm();">Add</button>
                                        <a class="btn btn-secondary"
                                            href="<?php echo e(route('admin-commercial-property.index')); ?>">
                                            Close
                                        </a>
                                    </div>
                                    <?php echo Form::close(); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\kotha-bhada\resources\views/admin/commercial-property/index.blade.php ENDPATH**/ ?>