            ...
            <div class="col-12">
                <div class="siteTitle">
                    <h3>
                        ...
                        <?php echo e($setting->recommended_term); ?>
...
<?php endif; ?>
            ...
            <div class="col-12 text-end">
                <a href="<?php echo e(route('front.recommended')); ?>" class="siteBtn d-inline-block mt-3 text-end py-2">
...
<?php /**PATH E:\xampp\htdocs\harpal-realestate\resources\views/front/includes/recommended.blade.php ENDPATH**/ ?>