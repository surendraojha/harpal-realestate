    ...
    <div id="main-content">
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-12">
                    <div class="card">
                        <form action="<?php echo e(route('blog-category.index')); ?>" method="get">
                            <div class="body">
                                <div class="row">
...
<?php endif; ?>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?php echo e(route('blog-category.edit', $value->id)); ?>"> <i
                            ...
                            <div class="tab-pane <?php if(session()->get('errors')): ?> active show <?php endif; ?>" id="addUser">
                                <div class="body mt-2">
                                    ...
                                    <form action="<?php echo e(route('blog-category.store')); ?>" method="post" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <?php echo $__env->make('admin.blog-category.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-primary">Add</button>
                                            <a class="btn btn-secondary" href="<?php echo e(route('blog-category.index')); ?>">
                                                Close
                                            </a>
                                        </div>
                                    </form>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\harpal-realestate\resources\views/admin/blog-category/index.blade.php ENDPATH**/ ?>