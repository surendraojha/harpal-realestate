                ...
                <?php endif; ?>
                                ...
                                <div class="col-12 mt-3 mb-4">
                                    <div class="row border amenitiesWrapper">
                                        ...
                                        <?php if(@$information->category->title): ?>
                                            <div class="col-6 col-md-4 col-lg-3">
                                                <div class="amenities">
                                                    <div class="amenitiesTitle">
                                                        Main Category
                                        ...
                                        <div class="col-6 col-md-4 col-lg-3">
                                            <div class="amenities">
                                                ...
                                                <div class="amenitiesContent">
                                                    <?php echo e(date('Y/m/d', strtotime($information->updated_at))); ?>
...
<?php echo $__env->make('front.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\kotha-bhada\resources\views/front/property/show.blade.php ENDPATH**/ ?>