                            ...
                            <div class="table-responsive">
                                <form method="post">
                                    ...
                                    <button class="btn btn-danger" onclick="return confirm('Are You Sure?')"
                                        formaction="<?php echo e(route('financial-support.delete')); ?>" type="submit">
                                    ...
                                    <table class="table table-hover table-custom spacing8" id="myTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($value->loan_year); ?></td>

                                                <td><?php echo e(date('d M, Y',strtotime($value->created_at))); ?></td>
                                                <td>
                                                    <a href="<?php echo e(route('financial-support.edit',$value->id)); ?>"> <i
...
<?php endif; ?>
                        ...
                        <div class="tab-pane <?php if(session()->get('errors')): ?>  active show  <?php endif; ?>" id="addUser">
                            <div class="body mt-2">
                                ...
                                <?php echo Form::open(['route' => 'financial-support.store', 'method' => 'post','files'=>true]); ?>


                                    <?php echo csrf_field(); ?>
                                    <?php echo $__env->make('admin.financial-support.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">Add</button>
                                        <a class="btn btn-secondary" href="<?php echo e(route('financial-support.index')); ?>">
                                            Close
                                        </a>
                                    </div>
                                <?php echo Form::close(); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\harpal-realestate\resources\views/admin/financial-support/index.blade.php ENDPATH**/ ?>