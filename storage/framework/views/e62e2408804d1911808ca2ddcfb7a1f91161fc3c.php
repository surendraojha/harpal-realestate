                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating customForm">
                                                <input type="tel" name="phone" class="form-control" value="<?php echo e(old('phone')); ?>"
                                                    id="pNumber" placeholder="eg.John" required>
                                                <label for="pNumber">
                                                    Phone Number
                                                </label>
                                            </div>
...
<?php echo $__env->make('front.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\kotha-bhada\resources\views/front/shift-home/index.blade.php ENDPATH**/ ?>