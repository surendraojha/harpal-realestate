            ...
            <div class="col-md-5 mb-3">
                <div class="form-floating customForm">
                    <input type="text" name="title"
                        ...
                        value="<?php echo e(old('title', @$information->title)); ?>" id="title" placeholder="eg.John">
                    <label for="fName">
            ...
            <div class="col-md-6 mb-3">
                ...
                <?php endif; ?>
                   <div id="add-more-photos">
                    ...
                    <?php if($current_route == 'residental-property.edit'): ?>
            ...
            <div class="col-md-4 mb-3">
                <div class="form-floating customForm">
                    <input type="text" name="bedroom"
                        class="form-control <?php echo e($errors->has('bedroom') ? ' is-invalid' : ''); ?>"
                        id="bedroom"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4 mb-3">
                <div class="form-floating customForm">
                    ...
                    ?>
                    <?php echo Form::select('furnishing', $furnishing, @$information->furnishing,
            ...
            <div class="col-md-4 mb-3">
                <div class="form-floating customForm">
                    <select name="balcony" id="balcony"
                        ...
                        <option value="" disabled selected>Select Option</option>
                        <option value="1" <?php echo e(old('balcony', @$information->balcony) == '1' ? 'selected' : ''); ?>>Yes
                        </option>
                        <option value="0" <?php echo e(old('balcony', @$information->balcony) == '0' ? 'selected' : ''); ?>>No
                        </option>
                    </select>
                    <label for="balcony">
                        Balcony
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4 mb-3">
                <div class="form-floating customForm">
                    ...
                    <?php echo Form::number('shitting_room', @$information->shitting_room, ['class' => 'form-select form-control ',
                    'id'=>'shitting_room']); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-floating customForm">
                    <input type="text" name="location_for_map"
                        class="form-control <?php echo e($errors->has('location_for_map') ? ' is-invalid' : ''); ?>" id="geo-code"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-12 mb-3">
                ...
                <div class="form-floating customForm">
                    ...
                    <textarea name="overview" id="" class="form-control ckeditor w-100 <?php echo e($errors->has('overview') ? ' is-invalid' : ''); ?>"
...
<?php /**PATH E:\xampp\htdocs\harpal-realestate\resources\views/front/residental-property/form.blade.php ENDPATH**/ ?>