...
<div id="main-content">
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-12">
                <div class="card">
                    <form action="<?php echo e(route('child-category.index')); ?>" method="get">
                        <div class="body">
                            <div class="row">
                            ...
                            <div class="table-responsive">
                                <form method="post">
                                    <?php echo csrf_field(); ?>
                                       ...
                                       <?php
                                            $route = route('child-category.delete');
                                        ?>
...
<?php endif; ?>
                                                ...
                                                <td>
                                                    <a href="<?php echo e(route('child-category.edit',$value->id)); ?>"> <i
...
<?php endif; ?>
                        ...
                        <div class="tab-pane <?php if(session()->get('errors')): ?>  active show  <?php endif; ?>" id="addUser">
                            <div class="body mt-2">
                                ...
                                <?php echo Form::open(['route' => 'child-category.store', 'method' => 'post']); ?>


                                    <?php echo csrf_field(); ?>
                                    <?php echo $__env->make('admin.child-category.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">Add</button>
                                        <a class="btn btn-secondary" href="<?php echo e(route('child-category.index')); ?>">
                                            Close
                                        </a>
                                    </div>
                                <?php echo Form::close(); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\harpal-realestate\resources\views/admin/child-category/index.blade.php ENDPATH**/ ?>