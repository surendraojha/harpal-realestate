            ...
            <div class="col-md-8 mb-3">
                <div class="form-floating customForm">
                    <input type="text" name="title"
                        ...
                        value="<?php echo e(old('title', @$information->title)); ?>" id="title" placeholder="eg.John" max="100">
                    <label for="fName">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                ...
                <div id="add-more-photos">
                    ...
                    <?php if($current_route == 'commercial-property.edit'): ?>
                        <?php echo $__env->make('front.property.edit-photos', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-3">
                <div class="form-floating customForm">
                    ...
                    <input type="text" name="buld_up_area"
                        class="form-control <?php echo e($errors->has('buld_up_area') ? ' is-invalid' : ''); ?>"
                        id="buld_up_area" placeholder="eg. 1,2,3 .."
                        value="<?php echo e(old('buld_up_area', @$information->buld_up_area)); ?>">

                    <label for="bathroom">
                        Build Up Area
                    </label>

                    <?php $__errorArgs = ['buld_up_area'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            ...
            <div class="col-md-4 mb-3">
                <div class="form-floating customForm">
                    ...
                    <input type="text" name="area_covered"
                        class="form-control <?php echo e($errors->has('area_covered') ? ' is-invalid' : ''); ?>"
                        id="area_covered" placeholder="eg. 1,2,3 .."
                        value="<?php echo e(old('area_covered', @$information->area_covered)); ?>">
            ...
            <div class="col-md-4 mb-3">
                <div class="form-floating customForm">
                    ...
                    <select name="parking" id="parking"
                        class="form-select form-control <?php echo e($errors->has('parking') ? ' is-invalid' : ''); ?>">
                        <option value="" disabled selected>--Select Option--</option>
                        <option value="Yes" <?php echo e(old('parking', @$information->parking == 'Yes' ? 'selected' : '')); ?>>
                            Yes
                        </option>
                        <option value="No" <?php echo e(old('parking', @$information->parking == 'No' ? 'selected' : '')); ?>>No
                        </option>
                    </select>
            ...
            <div class="col-md-4 mb-3">
                <div class="form-floating customForm">
                    <select name="pantry" id="pantry"
                        class="form-select form-control <?php echo e($errors->has('pantry') ? ' is-invalid' : ''); ?>">
                        <option value="" disabled selected>Select Option</option>
                        <option value="1" <?php echo e(old('pantry', @$information->pantry) == '1' ? 'selected' : ''); ?>>Yes
                        </option>
                        <option value="0" <?php echo e(old('pantry', @$information->pantry) == '0' ? 'selected' : ''); ?>>No
                        </option>
                    </select>
                    <label for="pantry">
                        Pantry
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4 mb-3">
                <div class="form-floating customForm">
                    ...
                    ?>
                    <?php echo Form::select('faced', $faced, @$information->faced, ['class' => 'form-select form-control ',
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4 mb-3">
                <div class="form-floating customForm">
                    ...
                    ?>
                    <?php echo Form::select('lift', $lift, @$information->lift, ['class' => 'form-select form-control ','id'=>'lift']); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4 mb-3">
                <div class="form-floating customForm">
                    ...
                    <?php echo Form::number('shitting_room', @$information->shitting_room, ['class' => 'form-select form-control ','id'=>'shitting_room']); ?>
            ...
            <div class="col-md-6 mb-3">
                <div class="form-floating customForm">
                    ...
                    <input type="tel" name="contact_number"
                        ...
                        id="contact_number" placeholder="eg. 1,2,3 .." value="<?php echo e($number); ?>" max="15">
                ...
                <div class="append-locations mt-4 mb-4">
                    <div class="form-floating customForm">
                        ...
                        <select name="location_id" id="location_id"
                            class="select2 <?php echo e($errors->has('location_id') ? ' is-invalid' : ''); ?>" multiple>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-12 mb-3">
                ...
                <div class="form-floating customForm">
                    ...
                    <textarea name="overview" id="" class="form-control ckeditor <?php echo e($errors->has('overview') ? ' is-invalid' : ''); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php if(@$information): ?>
                <?php if (isset($component)) { $__componentOriginalc80e284c9ed32210b1583c10e9cfce9423f2b6a7 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\LocalAreaFacility::class, ['features' => $additional_features,'checked' => $checked_features]); ?>
<?php $component->withName('local-area-facility'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc80e284c9ed32210b1583c10e9cfce9423f2b6a7)): ?>
<?php $component = $__componentOriginalc80e284c9ed32210b1583c10e9cfce9423f2b6a7; ?>
<?php unset($__componentOriginalc80e284c9ed32210b1583c10e9cfce9423f2b6a7); ?>
<?php endif; ?>
            <?php else: ?>


                <?php if (isset($component)) { $__componentOriginalc80e284c9ed32210b1583c10e9cfce9423f2b6a7 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\LocalAreaFacility::class, ['features' => $additional_features]); ?>
<?php $component->withName('local-area-facility'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php /**PATH E:\xampp\htdocs\harpal-realestate\resources\views/front/commercial-property/form.blade.php ENDPATH**/ ?>