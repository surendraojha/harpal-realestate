                            ...
                            <div class="tab-pane  <?php if(!session()->get('errors')): ?> active show <?php endif; ?>" id="Users">
                                <div class="table-responsive">
                                    <form method="post">
                                        ...
                                        <?php
                                            $route = route('featured-property.delete');
                                        ?>
...
<?php endif; ?>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo e(route('featured-property.edit', $value->id)); ?>"> <i
...
<?php endif; ?>
                            ...
                            <div class="tab-pane <?php if(session()->get('errors')): ?> active show <?php endif; ?>" id="addUser">
                                <div class="body mt-2">
                                    ...
                                    <?php echo Form::open(['route' => 'featured-property.store', 'method' => 'post']); ?>


                                    <?php echo csrf_field(); ?>
                                    <?php echo $__env->make('admin.featured-property.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">Add</button>
                                        <a class="btn btn-secondary" href="<?php echo e(route('featured-property.index')); ?>">
                                            Close
                                        </a>
                                    </div>
                                    <?php echo Form::close(); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\harpal-realestate\resources\views/admin/featured-property/index.blade.php ENDPATH**/ ?>