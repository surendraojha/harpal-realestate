...
unset($__errorArgs, $__bag); ?>
                ...
                <div id="add-more-photos">
                    ...
                    <?php if($current_route == 'admin-commercial-property.edit'): ?>
            ...
            <div class="col-md-6 mb-3">
                <div class="form-floating customForm">
                    <select name="status"  class="form-control">
                        <option value="" selected disabled>Select Option</option>
                        <option value="1" <?php echo e(old('status',@$information->status)== "1" ? 'selected':''); ?>>Active</option>
                        <option value="0" <?php echo e(old('status',@$information->status)== "0" ? 'selected':''); ?>>InActive</option>
                    </select>
...
<?php /**PATH D:\xampp\htdocs\kotha-bhada\resources\views/admin/commercial-property/form.blade.php ENDPATH**/ ?>